...
#define INJECTED_TARGET         "FF6.exe"
#define INJECTED_DLL            "magitek.dll"
#define INJECTED_DLL_FUNCTION   "TekInit"
...
int main(void)
{
    ...
    *(DWORD*)(buffer + i) = (DWORD)pGetProcAddress;
    ...
    strcpy(buffer + 2048 + strlen(INJECTED_DLL) + 1, INJECTED_DLL_FUNCTION);
